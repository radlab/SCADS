...
public class ItemTO extends AbstractTO {
	...
	public long getI_pub_date() {
		return i_pub_date;
	}
	public void setI_pub_date(long i_oub_date) {
		this.i_pub_date = i_oub_date;
	}
	...
	public long getI_avail() {
		return i_avail;
	}
	public void setI_avail(long i_avail) {
	...
	public void setI_dimensions(String i_dimensions) {
