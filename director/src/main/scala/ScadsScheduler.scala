...
object ScadsServerScheduler {
  System.loadLibrary("mesos")
	...
	def apply(name: String, mesosMaster: String, zookeep: String) = new ScadsServerScheduler(name, mesosMaster,zookeep)
...
class ScadsServerScheduler protected (name: String, mesosMaster: String, zookeeperCanonical:String) extends Scheduler {
