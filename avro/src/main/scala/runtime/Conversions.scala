    ...
    def apply(s: Schema, a: FromColl) = {
      ...
      if (a eq null) null
        ...
        new GenericArray[ToElem] {
          ...
          def add(index:Int, elem:ToElem) = sys.error("add NOT SUPPORTED")
          def clear = sys.error("CLEAR NOT SUPPORTED - ARRAY IS IMMUTABLE")
          def peek = sys.error("PEEK NOT SUPPORTED")
          def reverse = sys.error("REVERSE NOT SUPPORTED")
          def subList(fromIndex:Int,toIndex:Int) = sys.error("subList NOT SUPPORTED")
          def listIterator(index:Int) = sys.error("listIterator NOT SUPPORTED") 
          def listIterator = sys.error("listIterator NOT SUPPORTED") 
          def lastIndexOf(o:Object) = sys.error("lastIndexOf NOT SUPPORTED") 
          def indexOf(o:Object) = sys.error("indexOf NOT SUPPORTED")
          def remove(index:Int) = sys.error("remove NOT SUPPORTED")
          def set(index:Int, elem:ToElem) = sys.error("set NOT SUPPORTED")
          def get(index:Int) = sys.error("get NOT SUPPORTED")
          def retainAll(c:java.util.Collection[_]) = sys.error("retainAll NOT SUPPORTED")
          def removeAll(c:java.util.Collection[_]) = sys.error("removeAll NOT SUPPORTED")
          def addAll(index:Int, c:java.util.Collection[_ <: ToElem]) = sys.error("addAll NOT SUPPORTED") 
          def addAll(c:java.util.Collection[_ <: ToElem]) = sys.error("addAll NOT SUPPORTED")
          def containsAll(c:java.util.Collection[_]) = sys.error("containsAll NOT SUPPORTED")
          def remove(o:Object) = sys.error("remove NOT SUPPORTED")
          def contains(o:Object) = sys.error("contains NOT SUPPORTED")
          def toArray[ToElem](t:Array[ToElem with Object]) = sys.error("toArray NOT SUPPORTED")
          def toArray = sys.error("toArray NOT SUPPORTED")
