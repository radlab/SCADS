...
case class TopKRequest(var minKey: Option[Array[Byte]], var maxKey: Option[Array[Byte]], var orderingFields: Seq[String], var k: Int) extends AvroRecord with KeyValueStoreOperation
